...
-define(OPTIONS ,[
  ...
  {decoder,                input,  "-c:",                    [{{ffmpeg_options, is_integer_and_list}, to_dotargs}]},
  {itoffset,               input,  "-itsoffset",             [{{erlang, is_list}, to_arg}, {{erlang, is_integer}, to_arg}]},
  {input_frame_rate,       input,  "-r:",                    [{{ffmpeg_options, is_integer_and_integer}, to_dotargs}]},
  {input_frame_size,       input,  "-s:",                    [{{ffmpeg_options, is_integer_and_integer}, to_dotargs}]},
  ...
  {output_frame_size,      output, "-s",                     [{{ffmpeg_options, is_list_and_integer}, to_dotargs}, {{erlang, is_integer}, to_arg}]},
